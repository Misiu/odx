...
export const DISPLAY_PROFILES: DisplayProfile[] = [
  ...
  solum('solum-newton-pro-5-8', 'Newton Pro 5.8″', 5.8, 792, 272, { columns: 5, rows: 2 }, { columns: 2, rows: 5 }),
  solum('solum-newton-pro-5-8-f', 'Newton Pro 5.8″ Freezer', 5.8, 792, 272, { columns: 5, rows: 2 }, { columns: 2, rows: 5 }, true),
